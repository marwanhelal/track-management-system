...
('VIS', NULL, 'توقيع الوردات', 'Projections Marking', 3, true),
('VIS', NULL, 'دراسة الموقع', 'Site Study', 4, true),
('VIS', NULL, 'الدراسة الفنية', 'Technical Study', 5, true),
('VIS', NULL, 'دراسات أخرى (دراسة الدرج)', 'Other Studies (Stair Study)', 6, true),
...
('VIS', NULL, 'المساحة النهائية للدور الأرضي', 'Ground Floor Final Area', 10, true),
('VIS', NULL, 'مسقط الدور المكرر', 'Typical Floor Plan', 11, true),
('VIS', NULL, 'المساحة النهائية للدور المكرر', 'Typical Floor Final Area', 12, true),
...
('VIS', NULL, 'للاندسكيب (Landscape)', 'Landscape', 18, true),
